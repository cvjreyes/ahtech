<?php 
                  ...
                  echo "<table border style='width: 100%'>";
                    ...
                    echo "<tr>";
                          ...
                          echo "<td style='text-align: center;width: 11.11%;font-size:13px;font-weight:normal'>Progress</td>";
                          echo "<td style='text-align: center;width: 11.11%;font-size:13px;font-weight:normal'>Requested</td>";
