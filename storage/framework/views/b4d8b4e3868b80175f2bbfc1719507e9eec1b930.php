  ...
  <body>
                      ...
                      <script type="text/javascript">
                        ...
                        <table border="1" bordercolor="#D6D4D3" class="table table-striped"  style="width:100%;font-size: 14px;font-weight: normal;background-color: #FFFFFF">
                            <thead>
                                <tr>
                                  <th colspan="6"><h4><b>Hours Budget</b></h4></th>
                                </tr>
                            ...
                            <tbody class="resultbody" style="margin-left: 40%">
                                <tr>
                                    ...
                                    <td style="">
                                     ...
                                     <td style="">
                                        <button onclick="location.href='<?php echo e(url('typescivil')); ?>'" type="button" class="btn btn-default btn-lg">SOE&nbsp;&nbsp;<img src="<?php echo e(asset('images/stru-icon.png')); ?>" style="width:50px" ></button>
                                    </td>
                                    <td style="">
                                        <button onclick="location.href='<?php echo e(url('typescivil')); ?>'" type="button" class="btn btn-default btn-lg">SOE&nbsp;&nbsp;<img src="<?php echo e(asset('images/stru-icon.png')); ?>" style="width:50px" ></button>
                                    </td>
