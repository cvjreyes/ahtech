  ...
  <div class="row">
    ...
    <center><h2 style="padding-top: 4%"><b><i>IsoTracker</i></b></h2>
      ...
      <div class="panel-body">
        <form id="frm-example" class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/sendfromisobulk')); ?>">    
       <?php echo csrf_field(); ?>     
...
$(document).on('click', '.show-vcomments-modal', function() {
    ...
    <!-- BUTTONS FOR SELECT ALL  --> 
      ...
      <?php echo Form::select('trn[]', [null => 'Select Transmittal...'] + $trn , null, array('style'=>'height:34px;font-size: 14px;font-weight: normal;')); ?>


      Date: <?php echo Form::text('issuedate', $issuedate, array('id' => 'issuedate','style'=>'height:34px;font-size: 14px;font-weight: normal;',required)); ?>
   ...
   <center>
        ...
        <button onclick="location.href='<?php echo e(url('iso')); ?>'" type="button" class="btn btn-primary btn-lg" style="width:15%"><b>LDE/Isocontrol</b></button>
...
<?php endif; ?>
<?php echo $__env->make('isoctrl.rejectfromiso', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.uploadfromdesign', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.commentsfromiso', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
