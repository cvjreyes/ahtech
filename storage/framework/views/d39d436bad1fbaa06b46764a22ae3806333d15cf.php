  ...
  <div class="row">
    ...
    <center><h2 style="padding-top: 4%"><b><i>IsoTracker</i></b></h2>
      ...
      <div class="panel-body">
         <form id="frm-example" class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/sendfromsupportsbulk')); ?>">    
       <?php echo csrf_field(); ?>     
        <table style='width: 100%'> 
        <td>         
          <button onclick="location.href='<?php echo e(url('isostatus')); ?>'" type="button" class="btn btn-info btn-lg" style="width:38%"><b>Status</b>
            </button>
...
$(document).on('click', '.show-vcomments-modal', function() {
    ...
    <tr>
      ...
      <td> 
        ...
        <!--    CHECK BY SPO/SIT  -->
           <?php echo $__env->make('isoctrl.design-checkby', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
   ...
   <center>
        ...
        <button onclick="location.href='<?php echo e(url('design')); ?>'" type="button" class="btn btn-default btn-lg" style="width:15%"><b>Design</b></button>&nbsp;&nbsp;
        ...
        <button onclick="location.href='<?php echo e(url('supports')); ?>'" type="button" class="btn btn-primary btn-lg" style="width:15%"><b>Supports</b></button>&nbsp;&nbsp;
        ...
        <button onclick="location.href='<?php echo e(url('lead')); ?>'" type="button" class="btn btn-default btn-lg" style="width:15%"><b>Issuer</b></button>&nbsp;&nbsp;
...
<?php echo $__env->make('isoctrl.rejectfromsupports', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.rejectfromldgsupportstodesign', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.rejectfromldgsupports', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.commentsfromldgsupportstoldgstress', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.commentsfromldgsupportstomaterials', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.commentsfromsupportstostress', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.commentsfromsupports', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
