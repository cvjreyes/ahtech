                    ...
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                <tr>
                                    ...
                                    <td>
                                        <?php echo Form::select('tcivils_id[]', [null => 'Select Type...'] + $tcivils, null, array( 'style'=>'height:31px','required')); ?>
                        ...
                        <input onclick="location.href='<?php echo e(url('civils')); ?>'" type="submit" class="btn btn-lg btn-default" data-dismiss="modal" value="Cancel">
