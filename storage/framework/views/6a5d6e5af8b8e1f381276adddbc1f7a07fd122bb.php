...
<br><br><img src="<?php echo e(asset('images/maint-logo.png')); ?>" style="width:80px;height:80px">

<br><br>You can continue using the application through the menu bar.

<br><br><img src="<?php echo e(asset('images/menu-sorry.png')); ?>" style="width:300px;height:75px;"></h1>
