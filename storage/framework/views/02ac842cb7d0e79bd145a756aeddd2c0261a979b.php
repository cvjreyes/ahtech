...
<div class="container">
    ...
    <center>
        ...
        <td>
             <button onclick="location.href='<?php echo e(url('isostatus')); ?>'" type="button" class="btn btn-info btn-lg" style="width:25%"><b>Status</b>
                </button>
             <button onclick="location.href='<?php echo e(url('hisoctrl')); ?>'" type="button" class="btn btn-primary btn-lg" style="width:25%"><b>History</b>
                </button>
                <button onclick="location.href='<?php echo e(url('exportisodates')); ?>'" type="button" class="btn btn-success btn-lg" style="font-weight: bold">Excel</button>
       </td>         
...
$(document).ready(function() {
    oTable = $('#hisoctrls').DataTable({
        ...
        "processing": true,
        "serverSide": false,
        "ajax": "<?php echo e(route('isoctrl.index')); ?>",
        "order": [[ 1, "desc" ]],
        "pageLength" : 8,
        "columns": [
...
<br>
 ...
 <!-- BUTTONS   -->
    <center>
        ...
        <button onclick="location.href='<?php echo e(url('lead')); ?>'" type="button" class="btn btn-default btn-lg" style="width:8%"><b>Lead</b></button>&nbsp;&nbsp;

        <button onclick="location.href='<?php echo e(url('iso')); ?>'" type="button" class="btn btn-default btn-lg" style="width:8%"><b>IsoController</b></button>
    </center>
