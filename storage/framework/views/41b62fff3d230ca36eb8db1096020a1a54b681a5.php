    ...
    <center><h2 style="padding-top: 4%"><b>Iso Controller</b></h2>
      ...
      <div class="panel-body">
       ...
       <?php echo csrf_field(); ?>     
        ...
        <td>         
          <button onclick="location.href='<?php echo e(url('isostatus')); ?>'" type="button" class="btn btn-info btn-lg" style="width:35%"><b>Status</b>
            </button>
           <button onclick="location.href='<?php echo e(url('hisoctrl')); ?>'" type="button" class="btn btn-info btn-lg" style="width:35%"><b>History</b>
          </button>
        </td>
        <td>
