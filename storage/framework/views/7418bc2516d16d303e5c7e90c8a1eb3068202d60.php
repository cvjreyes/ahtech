        ...
        <div class="col-md-4 col-md-offset-4" >
            <div class="panel panel-default" style="border-radius: 20px;">
                ...
                <div class="panel-body">
                   ...
                   <?php if(auth()->check() && auth()->user()->hasRole('Pipe')): ?> <div id="menu_sel" style="height: 50px;border-radius: 4px;transition:200ms;" onMouseOver="this.style.background='#E0E0E0';" onMouseOut="this.style.background='white';"><a href="glineprogresstotal" style="color:black;text-decoration:none;"><h4 style="padding-top: 5px" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='black'">&nbsp;&nbsp;<img src="<?php echo e(asset('images/chart-color-icon.png')); ?>" style="width:40px;height:40px">&nbsp;&nbsp;&nbsp;3D Progress&nbsp;&nbsp;(Weight: <?php echo $weight_total." | 100%";?>)
                 ...
                 <!-- FIN 3D progress curve -->                    
                    ...
                    <?php if(auth()->check() && auth()->user()->hasRole('Isoctrl')): ?><div id="menu_sel" style="height: 50px;border-radius: 4px;transition:200ms;" onMouseOver="this.style.background='#E0E0E0';" onMouseOut="this.style.background='white';"><a href="hisoctrl" style="color:black;text-decoration:none;"><h4 style="padding-top: 5px" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='black'">&nbsp;&nbsp;<img src="<?php echo e(asset('images/file-icon.png')); ?>" style="width:40px;height:40px">&nbsp;&nbsp;&nbsp;Iso Controller
                    ...
                    <?php if(auth()->check() && auth()->user()->hasRole('Pipe')): ?><div id="menu_sel" style="height: 50px;border-radius: 4px;transition:200ms;" onMouseOver="this.style.background='#E0E0E0';" onMouseOut="this.style.background='white';"><a href="epipes" style="color:black;text-decoration:none;"><h4 style="padding-top: 5px" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='black'">&nbsp;&nbsp;<img src="<?php echo e(asset('images/pipe-icon.png')); ?>" style="width:40px;height:40px">&nbsp;&nbsp;&nbsp;Piping&nbsp;&nbsp;(Weight: <?php echo round($weight_pipe[0]->weight,2)." | ".$per_pipe;?>)
                  ...
                  <!-- PIPING Total Progress -->
                    ...
                    <?php if(auth()->check() && auth()->user()->hasRole('Equi')): ?><div id="menu_sel" style="height: 50px;border-radius: 4px;transition:200ms;" onMouseOver="this.style.background='#E0E0E0';" onMouseOut="this.style.background='white';"><a href="eequis" style="color:black;text-decoration:none;"><h4 style="padding-top: 5px" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='black'">&nbsp;&nbsp;<img src="<?php echo e(asset('images/equi-icon.png')); ?>" style="width:40px;height:40px">&nbsp;&nbsp;&nbsp;Equipment&nbsp;&nbsp;(Weight: <?php echo round($weight_equi[0]->weight,2)." | ".$per_equi;?>)
...
<!--  PROGRESO POR AREAS EQUIPMENT -->
              ...
              <div class="panelaarea">
                <br>
                  ...
                  <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $areass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<!--  FIN PROGRESO POR AREAS EQUIPMENT -->
                  ...
                  <!-- CIVIL Total Progress -->
                   <?php if(auth()->check() && auth()->user()->hasRole('Civil')): ?> <div id="menu_sel" style="height: 50px;border-radius: 4px;transition:200ms;" onMouseOver="this.style.background='#E0E0E0';" onMouseOut="this.style.background='white';"><a href="ecivils" style="color:black;text-decoration:none;"><h4 style="padding-top: 5px" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='black'">&nbsp;&nbsp;<img src="<?php echo e(asset('images/stru-icon.png')); ?>" style="width:40px;height:40px">&nbsp;&nbsp;&nbsp;Civil&nbsp;&nbsp;(Weight: <?php echo round($weight_civil[0]->weight,2)." | ".$per_civil;?>)
              ...
              <div class="panela">      
                ...
                FROM
                  ...
                  <!-- INSTRUMENTATION Total Progress -->
                   <?php if(auth()->check() && auth()->user()->hasRole('Inst')): ?> <div id="menu_sel" style="height: 50px;border-radius: 4px;transition:200ms;" onMouseOver="this.style.background='#E0E0E0';" onMouseOut="this.style.background='white';"><a href="einsts" style="color:black;text-decoration:none;"><h4 style="padding-top: 5px" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='black'">&nbsp;&nbsp;<img src="<?php echo e(asset('images/inst-icon.png')); ?>" style="width:40px;height:40px">&nbsp;&nbsp;&nbsp;Instrumentation&nbsp;&nbsp;(Weight: <?php echo $weight_inst[0]->weight." | ".$per_inst;?>)
              ...
              <div class="panela">      
                ...
                FROM
                  ...
                  <!-- ELECTRICAL Total Progress -->
                   <?php if(auth()->check() && auth()->user()->hasRole('Elec')): ?> <div id="menu_sel" style="height: 50px;border-radius: 4px;transition:200ms;" onMouseOver="this.style.background='#E0E0E0';" onMouseOut="this.style.background='white';"><a href="eelecs" style="color:black;text-decoration:none;"><h4 style="padding-top: 5px" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='black'">&nbsp;&nbsp;<img src="<?php echo e(asset('images/elec-icon.png')); ?>" style="width:40px;height:40px">&nbsp;&nbsp;&nbsp;Electrical&nbsp;&nbsp;(Weight: <?php echo $weight_elec[0]->weight." | ".$per_elec;?>)
 ...
 -->
                            ...
                            <!--   <?php $__currentLoopData = $homeload; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $homeloads): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
