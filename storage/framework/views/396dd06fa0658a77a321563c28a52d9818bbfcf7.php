                    ...
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                <tr>
                                    ...
                                    <td>
                                        <?php echo Form::select('tcivils_id', [null => 'Select Type...'] + $tcivils , null, array('class' => 'tcivils_id','style'=>'width: 150px;height:34px;font-size: 14px;font-weight: normal;','required')); ?>
