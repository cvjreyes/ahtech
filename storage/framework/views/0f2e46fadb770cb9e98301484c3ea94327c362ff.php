   ...
   <div class="row">
        <div class="col-md-5 col-md-offset-3">
         ...
         <!--           Form::model($item, ['method' => 'PATCH','route' => ['indexcivil.update', $item->id]]) -->
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/updatecivil')); ?>">
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                <tr>
                                    ...
                                    <td>
                                        <?php echo Form::select('units_id', [null => 'Select Area...'] + $units, null, array('class' => 'units_id', 'style'=>'height:34px;font-size: 14px;font-weight: normal;','rcivilred')); ?>

                                    </td>
                                    <td>
                                        <?php echo Form::select('tcivils_id', [null => 'Select Type...'] + $tcivils , null, array('class' => 'tcivils_id','style'=>'width: 150px;height:34px;font-size: 14px;font-weight: normal;','rcivilred')); ?>
                                    ...
                                    <td>
                                        <?php echo Form::number('est_qty', null, array('placeholder' => 'Qty','class' => 'est_qty','style' => 'width: 100px;font-size: 14px;font-weight: normal;','rcivilred')); ?>
