  ...
  <div class="row">
    ...
    <center><h2 style="padding-top: 4%"><b>Iso Controller</b></h2>
      ...
      <div class="panel-body">
         <form id="frm-example" class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/sendfromleadbulk')); ?>">    
       <?php echo csrf_field(); ?>         
...
$(document).on('click', '.show-vcomments-modal', function() {
   ...
   <center>
        ...
        <button onclick="location.href='<?php echo e(url('lead')); ?>'" type="button" class="btn btn-primary btn-lg" style="width:15%"><b>LDG/Isochecker</b></button>&nbsp;&nbsp;
...
<?php endif; ?>
<?php echo $__env->make('isoctrl.rejectfromlead', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.uploadfromdesign', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.commentsfromlead', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
