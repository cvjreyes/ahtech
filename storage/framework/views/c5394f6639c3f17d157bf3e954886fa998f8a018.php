                    ...
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                <tr>
                                    ...
                                    <td>
                                    <?php //echo $id; ?>
                                        <?php echo Form::select('units_id', [null => 'Select Area...'] + $units, null, array('class' => 'units_id', 'style'=>'height:31px','required')); ?>

                                    </td>
                                    <td>
                                        <?php echo Form::select('tcivils_id', [null => 'Select Type...'] + $tcivils, null, array('class' => 'tcivils_id','style'=>'height:31px','required')); ?>

                                    </td>
                                    <td>
                                        <?php echo Form::number('hours', null, array('placeholder' => 'Hours','class' => 'hours','required')); ?>

                                    </td>
                                    <td>
                                        <?php echo Form::number('est_qty', null, array('placeholder' => 'Quantity','class' => 'est_qty','style'=>'weight:1005px','required')); ?>
