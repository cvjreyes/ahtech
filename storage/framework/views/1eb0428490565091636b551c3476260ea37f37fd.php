...
<?php else: ?>
    ...
    <div class="modal fade" id="commentsfromisobulkModal" style="top:20%"; 
        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/sendfromleadbulk')); ?>">
                    ...
                    <table class="table table-striped">
                            <thead>
                                <tr>
                                    <th style="font-size: 14px;font-weight: bold;">Iso IDs</th>
