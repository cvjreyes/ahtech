                ...
                <div style="width: 1300px" class="collapse navbar-collapse" id="app-navbar-collapse">  <!-- tamaño menu-->
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php else: ?>
                            ...
                            <?php if(auth()->check() && auth()->user()->hasRole('Equi')): ?><li id="s99"><a href="<?php echo e(route('home')); ?>" style="border-radius: 0px 0px 4px 4px;transition:200ms" onMouseOver="this.style.background='#B0BED9';this.style.color='white'" onMouseOut="this.style.background='white';this.style.color='black'"><img src="<?php echo e(asset('images/home-icon.png')); ?>" style="width:20px" ></a></li>

                            <li id="s0" class="dropdown" style="font-size: 13px">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" style="border-radius: 0px 0px 4px 4px;transition:200ms" onMouseOver="this.style.background='#B0BED9';this.style.color='white'" onMouseOut="this.style.background='white';this.style.color='black'" >Equipments <span class="caret"></a>
                            <ul class="dropdown-menu" role="menu">
                                <li style="font-size: 13px">
                                <a href="<?php echo e(route('equipments')); ?>">Estimated</a>
                                <a href="<?php echo e(route('modeledequi')); ?>">Modeled</a>
                            ...
                            <?php if(auth()->check() && auth()->user()->hasRole('Pipe')): ?><li id="s2" class="dropdown" style="font-size: 13px">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li style="font-size: 13px">
                                <a href="<?php echo e(route('pipes')); ?>">Main</a>
                        ...
                        <?php endif; ?>
                         ...
                         <!--    <li id="s2" style="font-size: 13px"><a href="pipes" style="border-radius: 0px 0px 4px 4px;transition:200ms" onMouseOver="this.style.background='#B0BED9';this.style.color='white'" onMouseOut="this.style.background='white';this.style.color='black'">Piping</a></li> -->
                           ...
                           <!--  <li class="dropdown">
                              ...
                              <!-- <li id="s00" style="font-size: 13px"><a href=""><strong>800126-COVESTRO</strong></a></li> -->
                              <!-- <li id="s00"><a href=""><img src="<?php echo e(asset('images/covestro_logo.png')); ?>" style="width:75px;"></a></li> -->
