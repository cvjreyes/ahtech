...
<!--     <center><h2 style="padding-top: 4%"><b><i>Naviswork</i></b></h2>
    ...
    <form id="frm-navis" class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/exportnavisxml')); ?>">    
       <?php echo csrf_field(); ?>
    ...
    <link href="https://cdn.datatables.net/buttons/1.4.2/css/buttons.dataTables.min.css" rel="stylesheet">
     ...
     <script type="text/javascript">
      ...
      <?php if (file_exists("../public/storage/navis/navis.xml")) { ?> 
          ...
          &nbsp;&nbsp;<a id="getxml" target='_blank' href="<?php echo e(asset('../public/storage/navis/navis.xml')); ?>" class="btn btn-lg btn-success" style="padding-top: 1%;width: 100%"><b><h3>Download XML</h3></b></a>
...
<script src="<?php echo e(asset('js/selectallnavis.js')); ?>"></script> <!-- select all -->
...
<?php echo $__env->make('layouts.datatablegeneric', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>