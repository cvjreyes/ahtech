        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/rejectfromldgsupportstodesign')); ?>">
                    ...
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                <tr>
                                    ...
                                    <td style="display: none;"> <?php echo Form::text('verifybystress', null, array('placeholder' => 'verifybystress','class' => 'verifybystress','readonly')); ?>
