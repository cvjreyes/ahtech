    ...
    $(function () {
        $('.add').click(function () {
            ...
            var tr = '<tr class="fila">' +
                    '<td><?php echo Form::select('field[]', array('area' => 'Area', 'diameter' => 'Diameter'));; ?></td>'+
                    '<td><?php echo Form::select('operator[]', array('=' => 'Equal', '!=' => 'Different', '>' => 'Greater Than', '>=' => 'Greater or Equal than', '<' => 'Less Than', '<=' => 'Less or Equal Than'));; ?></td>'+
                    '<td><?php echo Form::text('comparison[]', null, array('placeholder' => 'Comparison','class' => 'form-control','style' => 'font-size: 14px;font-weight: normal;','required')); ?></td>'+
...
<div class="container">
 ...
 <br> <br> 
  <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/filterpipes')); ?>">
                        <?php echo csrf_field(); ?>
...
<center><table id="eequi" class="table table-hover table-condensed" style="width: 60%;font-size: 14px;font-weight: normal;white-space: nowrap">
                                  ...
                                  <tbody class="resultbody">
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                                  <?php echo Form::select('comparison_a', [null => 'Select Area...'] + $units, null, array('id' => 'units_id','class' => 'comparison', 'style'=>'height:35px;border-radius: 4px;font-size: 14px;font-weight: normal;')); ?>

                                         
                                              
                                           
                                                 <?php echo Form::select('comparison_d', [null => 'Select Diameter...'] + $diameters, null, array('id' => 'diameters_id','class' => 'comparison', 'style'=>'height:35px;border-radius: 4px;font-size: 14px;font-weight: normal;display:none')); ?>

                                          
                                          </td>
                                          <td>
                                               <button id="action" type="submit" class="btn btn-lg btn-default" style="padding: 8px 16px;font-size: 12px"><img src="<?php echo e(asset('images/add-icon.ico')); ?>" style="width:18px" ></button>
                                          </td>
                                      </tr>
                       ...
                       <!--  <center><input id="add_btn" type="button" class="btn btn-lg btn-info add" style="padding: 8px 16px;font-size: 12px;" value="Add New (+)">  
                        ...
                        <input onclick="location.href='<?php echo e(url('filterpipes')); ?>'" type="submit" class="btn btn-lg btn-default" data-dismiss="modal" style="padding: 8px 16px;font-size: 12px;" value="Cancel"> -->
...
<?php if(auth()->check() && auth()->user()->hasRole('PipeAdmin')): ?><!-- <button style="align:right" type="button" class="btn btn-lg btn-default" data-toggle="modal" data-target="#createfilterpipeModal"><img src="<?php echo e(asset('images/add-icon.ico')); ?>" style="width:23px" ></button> --><?php endif; ?>
<br>
...
$(document).ready(function() {
    oTable = $('#filterpipes').DataTable({
        ...
        "processing": true,
        "serverSide": false,
        "ajax": "<?php echo e(route('piping.filter')); ?>",
        "columns": [
...
$(document).ready(function() {
    oTable = $('#filterpipes').DataTable({
        ...
        "processing": true,
        "serverSide": false,
        "ajax": "<?php echo e(route('piping.filterpipes')); ?>",
        "columns": [
            {data: 'code', name: 'code'},
            {data: 'name', name: 'name'},
                ...
                <div class="panel-body">
                   ...
                   <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/filterpipes')); ?>">
                        ...
                        <div class="modal-header" style="background-color: #F5F8FA;border-radius: 4px;">
                            <button onclick="location.href='<?php echo e(url('filterpipe')); ?>'" type="button" class="close" data-dismiss="modal"" aria-label="Close">
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.5.0/js/bootstrap-datepicker.js"></script>
               ...
               <center><table id="eequi" class="table table-hover table-condensed" style="width: 40%;font-size: 14px;font-weight: normal;white-space: nowrap">
                                  ...
                                  <tbody class="resultbody">
                                      ...
                                      <tr>
                                          <td>
                                             <?php echo Form::select('field[]', array('area' => 'Area', 'diameter' => 'Diameter'));; ?>

                                          </td>
                                          <td>
                                             <?php echo Form::select('operator[]', array('=' => 'Equal', '!=' => 'Different', '>' => 'Greater Than', '>=' => 'Greater or Equal than', '<' => 'Less Than', '<=' => 'Less or Equal Than'));; ?>

                                          </td>
                                         
                                              <td>
                                                <?php echo Form::text('comparison[]', null, array('placeholder' => 'Comparison','class' => 'form-control','style' => 'width:120px;font-size: 14px;font-weight: normal;','required')); ?>
...
<?php echo $__env->make('piping.delfilterpipe', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('piping.createfilterpipe', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
