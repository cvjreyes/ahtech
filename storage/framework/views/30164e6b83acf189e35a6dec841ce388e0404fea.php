...
if(isset($_POST["texto"]))
{
    ...
    if(isset($progress_by_line[0]->total_progress)){
    	    ...
    	    echo "<font size='5' color='#2579A9'><b>".$progress_by_line[0]->pdms_linenumber."</b></font>"."<br><b>PROGRESS: ".round($progress_by_line[0]->total_progress,2)."%</b>"."<br>PID: ".$progress_by_line[0]->pid."%"."<br>ISO: ".$progress_by_line[0]->iso."%"."<br>STRESS: ".$progress_by_line[0]->stress."%"."<br>SUPPORT: ".$progress_by_line[0]->support."%";
    	}else{
