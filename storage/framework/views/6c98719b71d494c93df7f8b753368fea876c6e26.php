...
<!--                                 <a href="<?php echo e(route('modeledequi')); ?>">Modeled</a>
                        ...
                        <?php endif; ?>
                         ...
                         <!--    <li id="s2" style="font-size: 13px"><a href="pipes" style="border-radius: 0px 0px 4px 4px;transition:200ms" onMouseOver="this.style.background='#B0BED9';this.style.color='white'" onMouseOut="this.style.background='white';this.style.color='black'">Piping</a></li> -->
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li style="font-size: 13px">
                                <a href="<?php echo e(route('civils')); ?>">Estimated</a>
                                <a href="<?php echo e(route('modeledcivil')); ?>">Modeled</a>
                           ...
                           <!--  <li class="dropdown">
                              ...
                              <!-- <li id="s00" style="font-size: 13px"><a href=""><strong>PROJECT LOGO</strong></a></li> -->
                               <li id="s00" style="font-size: 13px"><a href=""><strong>800124-BUTTERFLY</strong></a></li> 
                               <li id="s00"><a href=""><img src="<?php echo e(asset('images/cargill_logo.png')); ?>" style="width:55px;"></a></li>
