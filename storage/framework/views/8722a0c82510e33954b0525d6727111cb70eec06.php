        ...
        <div class="col-md-4 col-md-offset-4" >
            <div class="panel panel-default" style="border-radius: 20px;">
                ...
                <div class="panel-body">
                    ...
                    <div id="menu_sel" style="height: 50px;border-radius: 4px;transition:200ms;" onMouseOver="this.style.background='#E0E0E0';" onMouseOut="this.style.background='white';"><a href="equipments" style="color:black;text-decoration:none;"><h4 style="padding-top: 5px" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='black'">&nbsp;&nbsp;<img src="<?php echo e(asset('images/equi-icon.png')); ?>" style="width:40px;height:40px">&nbsp;&nbsp;&nbsp;Equipment&nbsp;&nbsp;(Weight: <?php echo round($weight_equi[0]->weight,2);?>)
              ...
              <div class="panela">      
                ...
                FROM
                  ...
                  <!-- CIVIL Total Progress -->
                   <?php if(auth()->check() && auth()->user()->hasRole('Civild')): ?> <div id="menu_sel" style="height: 50px;border-radius: 4px;transition:200ms;" onMouseOver="this.style.background='#E0E0E0';" onMouseOut="this.style.background='white';"><a href="civils" style="color:black;text-decoration:none;"><h4 style="padding-top: 5px" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='black'">&nbsp;&nbsp;<img src="<?php echo e(asset('images/stru-icon.png')); ?>" style="width:40px;height:40px">&nbsp;&nbsp;&nbsp;Civil&nbsp;&nbsp;(Weight: <?php echo $weight_civil[0]->weight;?>)
            ...
            <button class="accordion btn btn-lg btn-default" style="padding: 2px 8px;font-size: 14px;">by Areas</button>
              ...
              <?php $est_area=DB::select("SELECT DISTINCT COUNT(id) AS count FROM epipes"); 
                ...
                if (($est_area[0]->count)!=0){ //VALIDACIÓN SI NO HAY DATA DE ESTIMACIÓN
                    ...
                    <div id="menu_sel" style="height: 50px;border-radius: 4px;transition:200ms" onMouseOver="this.style.background='#E0E0E0'" onMouseOut="this.style.background='white';"><a href="pipes" style="color:black;text-decoration:none;"><h4 style="padding-top: 5px"  onMouseOver="this.style.color='black'" onMouseOut="this.style.color='black'">&nbsp;&nbsp;<img src="<?php echo e(asset('images/pipe-icon.png')); ?>" style="width:40px;height:40px">&nbsp;&nbsp;&nbsp;Piping&nbsp;&nbsp;(Weight: <?php echo $weight_pipe[0]->weight;?>)</h4></a></div>
                ...
                <br>
                            ...
                            <!-- por Areas PIPING -->
                              ...
                              <?php $__currentLoopData = $homeload; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $homeloads): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 ...
                                 <center><div id="bar_equi" class="progress" style="width: 80%">
                                          <div style="position:absolute;z-index: 1;left:35%;font-size: 13px"><?php echo "Area ".$homeloads->area.": ".$homeloads->progress."%"." (Weight: ".$homeloads->weight.")";?></div>
                                          <div class="progress-bar" role="progressbar" style="width:<?php echo $homeloads->progress."%"; ?>;background-color: #B0BED9">
