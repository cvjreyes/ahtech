  ...
  <div class="row">
    ...
    <center><h2 style="padding-top: 4%"><b><i>IsoTracker</i></b></h2>
      ...
      <div class="panel-body">
        <form id="frm-example" class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/sendfromstressbulk')); ?>">    
       <?php echo csrf_field(); ?>
...
$(document).on('click', '.show-vcomments-modal', function() {
   ...
   <center>
        ...
        <button onclick="location.href='<?php echo e(url('stress')); ?>'" type="button" class="btn btn-primary btn-lg" style="width:15%"><b>Stress</b></button>&nbsp;&nbsp;
...
<?php echo $__env->make('isoctrl.rejectfromstress', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.rejectfromldgstresstoldgsupports', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.rejectfromldgstresstodesign', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.rejectfromldgstress', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.commentsfromldgstresstomaterials', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.commentsfromstresstolead', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.commentsfromstress', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
