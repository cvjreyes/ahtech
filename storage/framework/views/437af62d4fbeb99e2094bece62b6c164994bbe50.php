      ...
      <div class="col-md-9" style="left: 12%;margin-top: 4%;" >
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="margin-top: 4%">
                        ...
                        <center>
                           <br><br>
                        <button onclick="location.href='<?php echo e(url('elecs')); ?>'" type="button" class="btn btn-primary btn-lg">Estimated</button>
                        <button onclick="location.href='<?php echo e(url('milestoneselec')); ?>'" type="button" class="btn btn-primary btn-lg">Milestones</button>
