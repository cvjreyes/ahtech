...
<?php if(auth()->check() && auth()->user()->hasRole('InstAdmin')): ?><button style="align:right" type="button" class="btn btn-lg btn-default" data-toggle="modal" data-target="#createtypesinstModal"><img src="<?php echo e(asset('images/add-icon.ico')); ?>" style="width:23px" ></button>&nbsp;<?php endif; ?>
<button onclick="location.href='<?php echo e(url('exporttypeinst')); ?>'" type="button" class="btn btn-lg btn-success" style="font-size: 16px;font-weight: bold">Excel</button><br>
...
$(document).ready(function() {
    oTable = $('#typeinst').DataTable({
        ...
        "processing": true,
        "serverSide": false,
        "ajax": "<?php echo e(route('instruments.types')); ?>",
        "columns": [
            {data: 'code', name: 'code'},
            {data: 'name', name: 'name'},
...
$(document).ready(function() {
    oTable = $('#typeinst').DataTable({
        ...
        "processing": true,
        "serverSide": false,
        "ajax": "<?php echo e(route('instpment.types')); ?>",
        "columns": [
            {data: 'code', name: 'code'},
            {data: 'name', name: 'name'},
            {data: 'hours', name: 'hours'}
...
<script type="text/javascript">
  ...
  <button onclick="location.href='<?php echo e(url('glineinst')); ?>'" type="button" class="btn btn-primary btn-lg">Curve</button>
...
<?php echo $__env->make('instruments.deltypesinst', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('instruments.edittypesinst', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('instruments.createtypesinst', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
