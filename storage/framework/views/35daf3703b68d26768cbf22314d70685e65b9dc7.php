    ...
    $(function () {
        $('.add').click(function () {
            ...
            var tr = '<tr class="fila">' +
                    ...
                    '<td><?php echo Form::select('tequis_id[]', [null => 'Select Type...'] + $tequis, null, array( 'style'=>'height:34px;font-size: 14px;font-weight: normal;','required')); ?></td>'+
