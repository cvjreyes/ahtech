            ...
            <div class="container" style="">
                ...
                <div class="navbar-header" style="margin-top: 0px">
                    ...
                    <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                            ...
                            <img src="<?php echo e(asset('images/tpfmc_logo.svg')); ?>" style="width:200px;padding-bottom: 0px;" >
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php else: ?>
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <a href="<?php echo e(route('holds')); ?>">Holds</a>
...
<!--                                 <a href="<?php echo e(route('modeledequi')); ?>">Modelled</a>
                     ...
                     <!--            <a href="<?php echo e(route('glinecivil')); ?>">Progress Curve by Area</a> -->
                       ...
                       <!--          <a href="<?php echo e(route('glineelec')); ?>">Progress Curve by Area</a> -->
                         ...
                         <?php if(auth()->check() && auth()->user()->hasRole('Isoctrl')): ?><li id="s5" class="dropdown" style="font-size: 13px">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <a href="<?php echo e(route('lead')); ?>">Issuer</a>    
                                <a href="<?php echo e(route('iso')); ?>">LDE/Isocontrol</a>
                                <a href="<?php echo e(route('commontray')); ?>"><b>CHECK BY...</b></a>
                                </li>        
                            </ul>
                        </li>
                            <?php endif; ?>
