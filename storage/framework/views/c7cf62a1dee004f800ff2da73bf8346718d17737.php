...
<!--         <button onclick="location.href='<?php echo e(url('file')); ?>'" type="button" class="btn btn-info btn-lg" style="width:30%"><b>Upload Isofiles</b> -->
        </button><?php //}?>
      </td>
      <td>
...
<?php endif; ?>
<?php echo $__env->make('isoctrl.uploadfromcommon', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
