    ...
    $(function () {
        $('.add').click(function () {
            ...
            var tr = '<tr class="fila">' +
                    '<td><?php echo Form::text('tag[]', null, array('placeholder' => 'tag','class' => 'form-control','required')); ?></td>'+
                    '<td><?php echo Form::text('holds[]', null, array('placeholder' => 'holds','class' => 'form-control','required')); ?></td>'+
                    '<td><?php echo Form::text('description[]', null, array('placeholder' => 'description','class' => 'form-control','required')); ?></td>'+
