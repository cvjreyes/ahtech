      ...
      <div class="col-md-9" style="left: 12%;margin-top: 4%;" >
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="margin-top: 4%">
                        ...
                        <center>
                          <form id="glineinst" class="form-horizontal" role="form" method="POST" action="<?php echo e(url('glineinst')); ?>">
                        ...
                        <center>
                           <br><br>
                        <button onclick="location.href='<?php echo e(url('insts')); ?>'" type="button" class="btn btn-primary btn-lg">Estimated</button>
                        <button onclick="location.href='<?php echo e(url('milestonesinst')); ?>'" type="button" class="btn btn-primary btn-lg">Milestones</button>
