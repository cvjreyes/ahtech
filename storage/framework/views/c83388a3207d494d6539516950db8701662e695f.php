      ...
      <h3>Upload Configuration</h3></center><br>
            ...
            <div style="margin-top: 2%" class="panel panel-default">
                ...
                <div class="panel-body"  style="width:100%">
                    ...
                    <?php echo Form::open(['route'=> 'filenavis.store', 'method' => 'POST', 'files'=>'true', 'id' => 'my-dropzone' , 'class' => 'dropzone']); ?>
            ...
            <center><h4><b>NOTE: Supported files (.xlsx)</b><h4>
                 <a target='_blank' href="<?php echo e(asset('../public/storage/navis/navis.xml')); ?>">DOWNLOAD LAST XML</a></center>
