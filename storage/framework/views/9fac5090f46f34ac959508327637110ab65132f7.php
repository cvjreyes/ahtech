...
<head>
    ...
    <!-- Styles -->
    <link href="<?php echo e(asset('css/ap.css')); ?>" rel="stylesheet">
                ...
                <div style="width: 1300px" class="collapse navbar-collapse" id="app-navbar-collapse">  <!-- tamaño menu-->
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php else: ?>
                            ...
                            <li id="s0" class="dropdown"><a href="<?php echo e(route('equipments')); ?>" style="border-radius: 0px 0px 4px 4px;transition:200ms" onMouseOver="this.style.background='#B0BED9';this.style.color='white'" onMouseOut="this.style.background='white';this.style.color='black'">Equipments</a></li>
                            <li id="s1"><a href="<?php echo e(route('civils')); ?>" style="border-radius: 0px 0px 4px 4px;transition:200ms" onMouseOver="this.style.background='#B0BED9';this.style.color='white'" onMouseOut="this.style.background='white';this.style.color='black'">Civil</a></li>
                            ...
                            <li id="s3"><a href="delecdistboardsdatatable" style="border-radius: 0px 0px 4px 4px;transition:200ms" onMouseOver="this.style.background='#B0BED9';this.style.color='white'" onMouseOut="this.style.background='white';this.style.color='black'">Instrumentation</a></li>
                             <li id="s0"><a href="<?php echo e(route('dashboard')); ?>" style="border-radius: 0px 0px 4px 4px;transition:200ms" onMouseOver="this.style.background='#B0BED9';this.style.color='white'" onMouseOut="this.style.background='white';this.style.color='black'"><strong>Dashboard</strong></a></li>
