    ...
    $(function () {
        $('.add').click(function () {
            ...
            var tr = '<tr class="fila">' +
                    '<td><?php echo Form::select('units_id[]', [null => 'Select Area...'] + $units, null, array( 'style'=>'height:34px;font-size: 14px;font-weight: normal;','required')); ?></td>'+
                    '<td><?php echo Form::select('tinsts_id[]', [null => 'Select Type...'] + $tinsts, null, array( 'style'=>'height:34px;font-size: 14px;font-weight: normal;','required')); ?></td>'+
                    '<td><?php echo Form::text('tag[]', null, array('placeholder' => 'Tag','class' => 'form-control','style' => 'font-size: 14px;font-weight: normal;','required')); ?></td>'+
                    '<td><?php echo Form::number('est_qty[]', null, array('placeholder' => 'Qty','class' => 'form-control','style' => 'width: 70px;font-size: 14px;font-weight: normal;','required')); ?></td>'+
...
<?php if(auth()->check() && auth()->user()->hasRole('InstAdmin')): ?><button style="align:right" type="button" class="btn btn-lg btn-default" data-toggle="modal" data-target="#createinstModal"><img src="<?php echo e(asset('images/add-icon.ico')); ?>" style="width:23px" ></button>&nbsp;<?php endif; ?>
<button onclick="location.href='<?php echo e(url('typesinst')); ?>'" type="button" class="btn btn-lg btn-default"><img src="<?php echo e(asset('images/inst-icon.png')); ?>" style="width:23px" ></button>
<button onclick="location.href='<?php echo e(url('exportinst')); ?>'" type="button" class="btn btn-lg btn-success" style="font-size: 16px;font-weight: bold">Excel</button><br>
...
<table border id="einst" class="table table-hover table-condensed" style="width: 100%;font-size: 14px;font-weight: normal;white-space: nowrap">
    <center><thead>
        <tr>
           ...
           <!--  <th>Quantity</th> -->
            <!-- <th>Estimated</th> -->
            <?php if(auth()->check() && auth()->user()->hasRole('InstAdmin')): ?> <th>Action</th> <?php endif; ?>
        </tr>
    </thead></center>
    <tfoot><tr>
...
<!--             <th style="text-align: center"></th> -->
            <!-- <th style="text-align: center"></th> -->
            <?php if(auth()->check() && auth()->user()->hasRole('InstAdmin')): ?> <th style="text-align: center"></th> <?php endif; ?>
        </tr></tfoot>
  </table>
...
<?php if(auth()->check() && auth()->user()->hasRole('InstAdmin')): ?>
    <script type="text/javascript">
    ...
    $(document).ready(function() {
        oTable = $('#einst').DataTable({
            ...
            "processing": true,
            "serverSide": false,
            "ajax": "<?php echo e(route('instruments.indexinst')); ?>",
            "columns": [
                {data: 'area', name: 'area'},
                {data: 'type', name: 'type'},
                //{data: 'code', name: 'code'},
...
?>
  ...
  <center>
  <button onclick="location.href='<?php echo e(url('modeledinst')); ?>'" type="button" class="btn btn-primary btn-lg">Modeled</button>
  ...
  <button onclick="location.href='<?php echo e(url('glineinst')); ?>'" type="button" class="btn btn-primary btn-lg">CurveByArea</button>
  <button onclick="location.href='<?php echo e(url('glineinsttotal')); ?>'" type="button" class="btn btn-primary btn-lg">Curve</button>
...
<?php echo $__env->make('instruments.delinst', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('instruments.editinst', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('instruments.createinst', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
