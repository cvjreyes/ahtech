...
<br><br>
  ...
  <body>
                      ...
                      <center><!-- <button type="submit" class="btn btn-default btn-lg">Refresh&nbsp;&nbsp;<img src="<?php echo e(asset('images/refresh-icon.png')); ?>" style="width:30px" ></button> -->
                      ...
                      <script type="text/javascript">
                        ...
                        <table border="1" bordercolor="#D6D4D3" class="table table-striped"  style="width:100%;font-size: 14px;font-weight: normal;background-color: #FFFFFF">
                            ...
                            <tbody class="resultbody" >
                               ...
                               <?php if ($locked==0){?>   
                                <tr>
                                    <td style="text-align:center;">Strt:&nbsp;     
                                        <?php echo Form::text('start', $start, array('id' => 'datepicker')); ?>

                                    
                                    </td>
                                    <td>End:&nbsp; 
                                         <?php echo Form::text('end', $end, array('id' => 'datepicker_end')); ?>

                                    
                                    </td>
                                    <td>Weeks:&nbsp; 
                                        <?php echo Form::number('weeks', $weeks, array('placeholder' => 'Required','class' => 'weeks','style'=>'width:80px;height:30px;border:0px;background-color:#F9F9F9','readonly')); ?>

                                    
                                    </td>
                                    <td style="display:none;">
                                        <?php echo Form::number('locked', $locked=1, array('placeholder' => 'Required','class' => 'weeks','style'=>'width:80px;height:30px;border:0px;background-color:#F9F9F9','required')); ?>
                                  ...
                                  <td>
                                    ...
                                    <center><button type="submit" class="" style="border:none;background-color: #F9F9F9"><img src="<?php echo e(asset('images/refresh-icon.png')); ?>" style="width:25px"></button></button></center>
                                  </td>

</body>
</html> 

                                        <!-- <button type="submit" style="border:none;background-color: #F9F9F9"><img src="<?php echo e(asset('images/unlocked-icon.png')); ?>" style="width:27px" ></button></center> --></td>
                              ...
                              <?php }else{ ?>
                                ...
                                <tr>
                                    <td style="text-align:center;">Start:&nbsp;     
                                        <?php echo Form::text('start', $start, array('id' => 'datepicker_dummy','style' => 'border:none;background-color: #F9F9F9','readonly')); ?>

                                    
                                    </td>
                                    <td>End:&nbsp; 
                                         <?php echo Form::text('end', $end, array('id' => 'datepicker_end_dummy','style' => 'border:none;background-color: #F9F9F9','readonly')); ?>

                                    
                                    </td>
                                    <td>Weeks:&nbsp; 
                                        <?php echo Form::number('weeks', $weeks, array('placeholder' => 'Required','class' => 'weeks','style'=>'width:80px;height:30px;border:0px;background-color:#F9F9F9','disabled')); ?>

                                    
                                    </td>
                                    <td style="display:none;">
                                        <?php echo Form::number('locked', $locked=0, array('placeholder' => 'Required','class' => 'weeks','style'=>'width:80px;height:30px;border:0px;background-color:#F9F9F9','required')); ?>
                                    ...
                                    <center><button type="" class="" style="border:none;background-color: #F9F9F9"><img src="<?php echo e(asset('images/locked-icon.png')); ?>" style="width:25px"></button></center>
                                  </td>                    
                            ...
                            <tbody class="resultbody" >
                                <tr>
                                    ...
                                    <td style="text-align:center;">Piping:&nbsp;     
                                        <?php echo Form::number('sw_pipe', $pipesweek, array('placeholder' => 'Required','class' => 'sw_pipe','style'=>$style_setting_td,$setting_td)); ?><br>
                                    ...
                                    <td>Equipment:&nbsp; 
                                        <?php echo Form::number('sw_equi', $equisweek, array('placeholder' => 'Required','class' => 'sw_equi','style'=>$style_setting_td,$setting_td)); ?><br>
                                    
                                    </td>

                                    <td>Civil:&nbsp; 
                                        <?php echo Form::number('sw_civil', $civilsweek, array('placeholder' => 'Required','class' => 'sw_civil','style'=>'width:80px;height:30px','required')); ?><br>
                                    
                                    </td>

                                    <td>Instrumentation:&nbsp; 
                                        <?php echo Form::number('sw_sit', $sitsweek, array('placeholder' => 'Readonly','class' => 'sw_sit','style'=>'width:80px;height:30px','required')); ?><br>
                                     
                                    </td>
                                    
                                    <td>Electrical:&nbsp; 
                                        <?php echo Form::number('sw_sel', $selsweek, array('placeholder' => 'Readonly','class' => 'sw_sel','style'=>'width:80px;height:30px','required')); ?><br>
                                      
                                    </td>
                                    
                                    
                                    
                                    <td><center><button type="submit" class="" style="border:none;background-color: #F9F9F9"><img src="<?php echo e(asset('images/refresh-icon.png')); ?>" style="width:25px"></button></center></td>
                                </tr>
                                  ...
                                  <!-- SE COMPRUEBA LA SELECCIÓN DE weight_total PARA PIPING   -->
                                    ...
                                    <?php if ($wtpipe==0){?> 
                                      ...
                                      <td style="text-align:center;width: 150px">Piping&nbsp;<br>
                                        ...
                                        <?php echo e(Form::radio('wtpipe', '0' , true)); ?>

                                        <?php echo e(Form::radio('wtpipe', '1' , false)); ?>
                                    ...
                                    <?php }else{ ?>
                                      ...
                                      <td style="text-align:center;width: 150px">Piping&nbsp;<br>
                                         <br>
                                         <font Size=2>Area</font>
                                         <?php echo e(Form::radio('wtpipe', '0' , false)); ?>

                                         <?php echo e(Form::radio('wtpipe', '1' , true)); ?>
                                    ...
                                    <?php if ($wtequi==0){?> 
                                      ...
                                      <td style="text-align:center;width: 150px">Equipment&nbsp;<br>
                                        <br>
                                        <font Size=2>Area</font>
                                        <?php echo e(Form::radio('wtequi', '0' , true)); ?>

                                        <?php echo e(Form::radio('wtequi', '1' , false)); ?>
                                    ...
                                    <?php }else{ ?>
                                      ...
                                      <td style="text-align:center;width: 150px">Equipment&nbsp;<br>
                                         <br>
                                         <font Size=2>Area</font>
                                         <?php echo e(Form::radio('wtequi', '0' , false)); ?>

                                         <?php echo e(Form::radio('wtequi', '1' , true)); ?>
                                    ...
                                    <?php if ($wtcivil==0){?> 
                                      ...
                                      <td style="text-align:center;width: 150px">Civil&nbsp;<br>
                                        <br>
                                        <font Size=2>Area</font>
                                        <?php echo e(Form::radio('wtcivil', '0' , true)); ?>

                                        <?php echo e(Form::radio('wtcivil', '1' , false)); ?>
                                    ...
                                    <?php }else{ ?>
                                      ...
                                      <td style="text-align:center;width: 150px">Civil&nbsp;<br>
                                         <br>
                                         <font Size=2>Area</font>
                                         <?php echo e(Form::radio('wtcivil', '0' , false)); ?>

                                         <?php echo e(Form::radio('wtcivil', '1' , true)); ?>
                                    ...
                                    <?php if ($wtinst==0){?> 
                                      ...
                                      <td style="text-align:center;width: 150px">Instrumentation&nbsp;<br>
                                        <br>
                                        <font Size=2>Area</font>
                                        <?php echo e(Form::radio('wtinst', '0' , true)); ?>

                                        <?php echo e(Form::radio('wtinst', '1' , false)); ?>
                                    ...
                                    <?php }else{ ?>
                                      ...
                                      <td style="text-align:center;width: 150px">Instrumentation&nbsp;<br>
                                         <br>
                                         <font Size=2>Area</font>
                                         <?php echo e(Form::radio('wtinst', '0' , false)); ?>

                                         <?php echo e(Form::radio('wtinst', '1' , true)); ?>
                                    ...
                                    <?php if ($wtelec==0){?> 
                                      ...
                                      <td style="text-align:center;width: 150px">Electrical&nbsp;<br>
                                        <br>
                                        <font Size=2>Area</font>
                                        <?php echo e(Form::radio('wtelec', '0' , true)); ?>

                                        <?php echo e(Form::radio('wtelec', '1' , false)); ?>
                                    ...
                                    <?php }else{ ?>
                                      ...
                                      <td style="text-align:center;width: 150px">Electrical&nbsp;<br>
                                         <br>
                                         <font Size=2>Area</font>
                                         <?php echo e(Form::radio('wtelec', '0' , false)); ?>

                                         <?php echo e(Form::radio('wtelec', '1' , true)); ?>
                            ...
                            <tbody class="resultbody" style="margin-left: 40%">
                                <tr>
                                    ...
                                    <td style="">
                                     ...
                                     <td style="">
                                        <button onclick="location.href='<?php echo e(url('typescivil')); ?>'" type="button" class="btn btn-default btn-lg">CIV&nbsp;&nbsp;<img src="<?php echo e(asset('images/stru-icon.png')); ?>" style="width:50px" ></button>
                                    </td>
                                    <td style="">
                                        <button onclick="location.href='<?php echo e(url('typesinst')); ?>'" type="button" class="btn btn-default btn-lg">INS&nbsp;&nbsp;<img src="<?php echo e(asset('images/inst-icon.png')); ?>" style="width:50px" ></button>
                                    </td>
                                    <td style="">
                                        <button onclick="location.href='<?php echo e(url('typeselec')); ?>'" type="button" class="btn btn-default btn-lg">ELE&nbsp;&nbsp;<img src="<?php echo e(asset('images/elec-icon.png')); ?>" style="width:50px" ></button>
                                    </td>
                                    <!-- <td>
