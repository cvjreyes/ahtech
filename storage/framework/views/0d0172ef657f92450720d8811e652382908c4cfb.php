                ...
                <div class="panel-body">
                   ...
                   <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/storecnotes')); ?>">
                        ...
                        <div class="modal-header" style="background-color: #F5F8FA;border-radius: 4px;">
                            <?php echo Form::text('pdms_linenumber[]', null, array('placeholder' => 'Calculation Note','class' => 'pdms_linenumber','style' => 'text-transform: uppercase;border:none;background: #F5F8FA;font-size:18px;font-weight:bold;width: 70%','disabled')); ?>
