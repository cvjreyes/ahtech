...
<div class="container">
    ...
    <table style='width: 100%'>
        <td>
             <button onclick="location.href='<?php echo e(url('isostatus')); ?>'" type="button" class="btn btn-primary btn-lg" style="width:25%"><b>Status</b>
                </button>
             <button onclick="location.href='<?php echo e(url('hisoctrl')); ?>'" type="button" class="btn btn-info btn-lg" style="width:25%"><b>History</b>
                </button>
