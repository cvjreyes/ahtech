                ...
                <div class="panel-body">
                   ...
                   <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/storecnotes')); ?>">
                        ...
                        <div class="modal-header" style="background-color: #F5F8FA;border-radius: 4px;">
                            <?php echo Form::text('name[]', null, array('placeholder' => 'USER ROLES','class' => 'name','style' => 'border:none;background: #F5F8FA;font-size:16px;font-weight:bold','disabled')); ?>

                                
                            <button onclick="location.href='<?php echo e(url('indexusers')); ?>'" type="button" class="close" data-dismiss="modal"" aria-label="Close">
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.5.0/js/bootstrap-datepicker.js"></script>
                    ...
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                ...
                                <tr>
                                    <td>
                                        <?php echo Form::select('roles_id[]', [null => 'Select Role...'] + $roles, null, array('style'=>'height: 35px;border-radius: 4px;','required')); ?>

                                    </td>
                                   <td style="display: none">
                                        <?php echo Form::text('id[]', null, array('placeholder' => 'pdms_linenumber','class' => 'id','style' => 'text-transform: uppercase','required')); ?>
                        ...
                        <input onclick="location.href='<?php echo e(url('indexusers')); ?>'" type="submit" class="btn btn-lg btn-default" data-dismiss="modal" style="padding: 8px 16px;font-size: 12px;" value="Cancel">
