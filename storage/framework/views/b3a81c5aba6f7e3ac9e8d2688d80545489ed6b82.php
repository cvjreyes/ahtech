         ...
         <!--           Form::model($item, ['method' => 'PATCH','route' => ['indexcivil.update', $item->id]]) -->
             ...
             <!--       <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/editcivil/')); ?>"> -->
                       ...
                       <div class="modal-header" style="background-color: #F5F8FA;border-radius: 4px;">
                        ...
                        <center>
                        <br>
                            <h4 class="modal-title">Are you sure you want to delete the following civils?</h4>
                            <br>
                    ...
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                <tr>
                                    ...
                                    <td>
                                        <?php echo Form::select('tcivils_id', [null => 'Select Type...'] + $tcivils, null, array('class' => 'tcivils_id', 'style'=>'height:31px','disabled')); ?>

                                    </td>
                                     <td>
                                        <?php echo Form::number('hours', null, array('placeholder' => 'Hours','class' => 'hours','disabled')); ?>
