...
<br><br>
  ...
  <body>
                      <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/updatepmanager')); ?>">
                        <?php echo e(csrf_field()); ?>
                            ...
                            <tbody class="resultbody">
                                ...
                                <tr>
                                    <td>    
                                        <?php echo Form::number('total_pipelines', $total_pipelines, array('placeholder' => 'Required','class' => 'total_pipelines','heigth'=>'3px' ,'disabled')); ?>
                                    ...
                                    <td>
                                        <?php echo Form::number('total_civil', $total_civil, array('placeholder' => 'Required','class' => 'total_civil','disabled')); ?>

                                    </td>
                                    <td>
                                        <?php echo Form::number('total_selsit', $total_selsit, array('placeholder' => 'Readonly','class' => 'total_selsit','disabled')); ?>
