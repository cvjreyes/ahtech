    ...
    $(function () {
        $('.add').click(function () {
            ...
            var tr = '<tr class="fila">' +
                    '<td><?php echo Form::select('roles_id[]', [null => 'Select Role...'] + $roles, null, array('style'=>'height: 35px;border-radius: 4px;','required')); ?></td>'+
...
<button onclick="location.href='<?php echo e(url('exportindexusers')); ?>'" type="button" class="btn btn-lg btn-success" style="font-size: 16px;font-weight: bold">Excel</button><br>
...
<?php echo $__env->make('user.createuroles', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
