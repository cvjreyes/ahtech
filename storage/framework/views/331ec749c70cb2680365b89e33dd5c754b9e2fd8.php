            ...
            <div class="container" style="">
                ...
                <div class="navbar-header" style="margin-top: 0px">
                    ...
                    <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                            ...
                            <img src="<?php echo e(asset('images/company-logo.png')); ?>" style="width:120px;padding-bottom: 0px;" >
                ...
                <div style="width: 1300px" class="collapse navbar-collapse" id="app-navbar-collapse">  <!-- tamaño menu-->
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php if(auth()->check() && auth()->user()->hasRole('Cliente')): ?>
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" style="border-radius: 0px 0px 4px 4px;transition:200ms" onMouseOver="this.style.background='#B0BED9';this.style.color='white'" onMouseOut="this.style.background='white';this.style.color='black'">Área Cliente <span class="caret"></a>
                            <ul class="dropdown-menu" role="menu">
                                <li style="font-size: 13px">
                                <a href="<?php echo e(route('home')); ?>">Home</a>
                                <a href="<?php echo e(route('viewcliente')); ?>">Ver Ficha</a>
                                </li>        
                            </ul>
                        </li>
                        <?php endif; ?>
                        ...
                        <?php if(auth()->check() && auth()->user()->hasRole('Admin')): ?>
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" style="border-radius: 0px 0px 4px 4px;transition:200ms" onMouseOver="this.style.background='#B0BED9';this.style.color='white'" onMouseOut="this.style.background='white';this.style.color='black'">Administrador <span class="caret"></a>
                            <ul class="dropdown-menu" role="menu">
                                <li style="font-size: 13px">
                                <a href="<?php echo e(route('tablaclientes')); ?>">Clientes</a>
                                </li>        
                            </ul>
                        </li>
                        <?php endif; ?>
                               ...
                               <li id="s00"><a href=""><img src="<?php echo e(asset('images/client-logo.png')); ?>" style="width:100px;"></a></li>
