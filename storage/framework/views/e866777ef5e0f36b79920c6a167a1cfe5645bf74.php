                ...
                <div class="panel-body">
                   ...
                   <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/equipments')); ?>">
                        ...
                        <div class="modal-header" style="background-color: #F5F8FA;border-radius: 4px;">
                            <button onclick="location.href='<?php echo e(url('eequis')); ?>'" type="button" class="close" data-dismiss="modal"" aria-label="Close">
                    ...
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo Form::select('areas_id[]', [null => 'Select Area...'] + $areas, null, array( 'style'=>'height:34px;font-size: 14px;font-weight: normal;','required')); ?>

                                    </td>
                                    <td>
                                        <?php echo Form::select('tequis_id[]', [null => 'Select Type...'] + $type_equi , null, array('style'=>'height:34px;font-size: 14px;font-weight: normal;','required')); ?>

                                    </td>
                                    <td>
                                        <?php echo Form::number('qty[]', null, array('placeholder' => 'Qty','style'=>'width: 75px','class' => 'form-control','min' => '1','required')); ?>

                                    </td>
                                   <!--  <td>
                                        <?php echo Form::number('est_qty[]', null, array('placeholder' => 'Qty','class' => 'form-control','style' => 'width: 70px;font-size: 14px;font-weight: normal;','required')); ?>
                        ...
                        <input onclick="location.href='<?php echo e(url('eequis')); ?>'" type="submit" class="btn btn-lg btn-default" style="padding: 8px 16px;font-size: 12px;" data-dismiss="modal" value="Cancel">
