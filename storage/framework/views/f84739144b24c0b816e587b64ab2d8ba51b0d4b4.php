        ...
        $('.add').click(function () {
            ...
            var n = ($('.resultbody tr').length - 0) + 1;
             var tr = '<tr class="fila">' +
                    '<td><?php echo Form::select('units_id[]', [null => 'Select Unit...'] + $units, null, array( 'style'=>'height:34px;font-size: 14px;font-weight: normal;','required')); ?></td>'+
                    ...
                    '<td><?php echo Form::select('tequis_id[]', [null => 'Select Type...'] + $tpipes, null, array( 'style'=>'height:34px;font-size: 14px;font-weight: normal;','required')); ?></td>'+
...
<?php echo $__env->make('piping.delcnotes', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
