...
<br>
<button onclick="location.href='<?php echo e(url('typesinst')); ?>'" type="button" class="btn btn-lg btn-default"><img src="<?php echo e(asset('images/stru-icon.png')); ?>" style="width:23px" ></button>
<button onclick="location.href='<?php echo e(url('exportmodeledinst')); ?>'" type="button" class="btn btn-lg btn-success" style="font-size: 16px;font-weight: bold">Excel</button><br>
<br>
...
$(document).ready(function() {
    oTable = $('#modeledinst').DataTable({
        ...
        "serverSide": false,
        "autoWidth": false,
        "ajax": "<?php echo e(route('instruments.dinstsfullquery')); ?>",
        "columns": [
            {data: 'unit', name: 'unit'},
            {data: 'area', name: 'area'},
            {data: 'tag', name: 'tag'},
...
<br>
  ...
  <button onclick="location.href='<?php echo e(url('instpments')); ?>'" type="button" class="btn btn-lg btn-default">Estimated</button>
