...
$(document).ready(function() {
    oTable = $('#milestonesequi').DataTable({
        ...
        "processing": true,
        "serverSide": false,
        "ajax": "<?php echo e(route('equipment.milestones')); ?>",
        "columns": [
            {data: 'area', name: 'area'},
            {data: 'week', name: 'week'},
...
<script type="text/javascript">
  ...
  <center>
  <button onclick="location.href='<?php echo e(url('equipments')); ?>'" type="button" class="btn btn-primary btn-lg">Estimated</button>
...
<?php echo $__env->make('equipment.editmilestonesequi', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
