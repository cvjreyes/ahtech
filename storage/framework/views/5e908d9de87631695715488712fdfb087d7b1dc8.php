  ...
  <div class="row">
    ...
    <form id="frm-example" class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/sendfromdesignbulk')); ?>">    
      ...
      <table style='width: 100%'> 
        <td>      
        <button onclick="location.href='<?php echo e(url('isostatus')); ?>'" type="button" class="btn btn-info btn-lg" style="width:30%"><b>Status</b>
        </button>
         <button onclick="location.href='<?php echo e(url('hisoctrl')); ?>'" type="button" class="btn btn-info btn-lg" style="width:30%"><b>History</b>
        </button>
...
<?php endif; ?>
<?php echo $__env->make('isoctrl.uploadfromtie', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
