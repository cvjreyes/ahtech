...
$(document).ready(function() {
    oTable = $('#modeledcivil').DataTable({
        ...
        "serverSide": false,
        "autoWidth": false,
        "ajax": "<?php echo e(route('civil.dcivilsfullquery')); ?>",
        "columns": [
            {data: 'unit', name: 'unit'},
            {data: 'area', name: 'area'},
            {data: 'tag', name: 'tag'},
...
<br>
  ...
  <button onclick="location.href='<?php echo e(url('civilpments')); ?>'" type="button" class="btn btn-lg btn-default">Estimated</button>
