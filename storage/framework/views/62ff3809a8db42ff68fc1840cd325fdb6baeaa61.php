...
<center><h3>PHOENIX Project EPC1</h3>
    <h4>HVO and PTT</h4>
                          ...
                          <!--   <button onclick="location.href='<?php echo e(url('createlinewindow')); ?>'" type="button" target="_blank" class="btn btn-lg">Add Line&nbsp;&nbsp;<img src="<?php echo e(asset('images/add-icon.ico')); ?>" style="width:20px" ></button> -->

                            <button onclick="window.open('createlinewindow','_blank', 'directories=no, location=no, menubar=no, scrollbars=yes, statusbar=no, tittlebar=no, resizable=no,width=1920, height=1080');" type="button" target="_blank" class="btn btn-lg">Add Line&nbsp;&nbsp;<img src="<?php echo e(asset('images/add-icon.ico')); ?>" style="width:20px" ></button>
...
$(document).ready(function() {
    ...
    oTable = $('#epipe').DataTable({
        ...
        "ajax": "<?php echo e(route('piping.ldlpipe')); ?>",
        "columns": [
