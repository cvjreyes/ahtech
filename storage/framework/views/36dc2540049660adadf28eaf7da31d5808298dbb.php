                ...
                <div class="panel-body">
                   ...
                   <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/civils')); ?>">
                        ...
                        <div class="modal-header" style="background-color: #F5F8FA;border-radius: 4px;">
                            <button onclick="location.href='<?php echo e(url('ecivils')); ?>'" type="button" class="close" data-dismiss="modal"" aria-label="Close">
                    ...
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo Form::select('areas_id[]', [null => 'Select Area...'] + $areas, null, array( 'style'=>'height:34px;font-size: 14px;font-weight: normal;','rcivilred')); ?>

                                    </td>
                                    <td>
                                        <?php echo Form::select('tcivils_id[]', [null => 'Select Type...'] + $type_civil , null, array('style'=>'height:34px;font-size: 14px;font-weight: normal;','rcivilred')); ?>

                                    </td>
                                    <td>
                                        <?php echo Form::number('qty[]', null, array('placeholder' => 'Qty','style'=>'width: 75px','class' => 'form-control','min' => '1','rcivilred')); ?>
                        ...
                        <input onclick="location.href='<?php echo e(url('ecivils')); ?>'" type="submit" class="btn btn-lg btn-default" style="padding: 8px 16px;font-size: 12px;" data-dismiss="modal" value="Cancel">
