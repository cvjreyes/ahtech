  ...
  <div class="row">
    ...
    <center><h2 style="padding-top: 4%"><b><i>IsoTracker</i></b></h2>
      ...
      <div class="panel-body">
         <form id="frm-example" class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/sendfrommaterialsbulk')); ?>">    
       <?php echo csrf_field(); ?>      
...
$(document).on('click', '.show-vcomments-modal', function() {
   ...
   <center>
        ...
        <button onclick="location.href='<?php echo e(url('materials')); ?>'" type="button" class="btn btn-primary btn-lg" style="width:15%"><b>Materials</b></button>&nbsp;&nbsp;
...
<?php echo $__env->make('isoctrl.rejectfrommaterials', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.commentsfrommaterials', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
