 ...
 <div class="modal fade" id="createequiModal";
    ...
    <div class="row">
        ...
        <?php $sum_per_equi = DB::select("SELECT SUM(total_progress) as sum_per_equi FROM pequis_view"); ?>
                ...
                <div class="panel-body">
                   ...
                   <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/milestoneequi')); ?>">
                        <?php echo csrf_field(); ?>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.5.0/js/bootstrap-datepicker.js"></script>
                    ...
                    <table class="table table-striped">
                        ...
                        <input onclick="location.href='<?php echo e(url('milestoneequi')); ?>'" type="submit" class="btn btn-lg btn-default" data-dismiss="modal" value="Cancel">
