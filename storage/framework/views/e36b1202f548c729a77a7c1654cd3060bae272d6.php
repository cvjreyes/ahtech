    ...
    $(function () {
        $('.add').click(function () {
            ...
            var tr = '<tr class="fila">' +
                    ...
                    '<td><?php echo Form::select('tpipes_id[]', [null => 'Select Type...'] + $type_line, null, array( 'style'=>'height:34px;font-size: 14px;font-weight: normal;','required')); ?></td>'+
...
<?php if(auth()->check() && auth()->user()->hasRole('EquiAdmin')): ?><button style="align:right" type="button" class="btn btn-lg btn-default" data-toggle="modal" data-target="#createepipeModal"><img src="<?php echo e(asset('images/add-icon.ico')); ?>" style="width:23px" ></button>&nbsp;<?php endif; ?>
...
$(document).ready(function() {
    oTable = $('#typeequi').DataTable({
        ...
        "processing": true,
        "serverSide": false,
        "ajax": "<?php echo e(route('piping.epipesfullquery')); ?>",
        "columns": [
            {data: 'area', name: 'area'},
...
$(document).ready(function() {
    oTable = $('#holdspipes').DataTable({
        ...
        "processing": true,
        "serverSide": false,
        "ajax": "<?php echo e(route('piping.holds')); ?>",
        "columns": [
            {data: 'tag', name: 'tag'},
            {data: 'action', name: 'action', orderable: false, searchable: false}
...
<script type="text/javascript">
  ...
  <center>
  <button onclick="location.href='<?php echo e(url('pipes')); ?>'" type="button" class="btn btn-primary btn-lg">Modelled</button>
...
<?php echo $__env->make('piping.delepipe', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('piping.editepipe', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('piping.createepipe', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
