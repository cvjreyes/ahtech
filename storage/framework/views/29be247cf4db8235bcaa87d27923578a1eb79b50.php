  ...
  <div class="row">
    ...
    <form id="frm-example" class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/sendfromdesignbulk')); ?>">    
      ...
      <table style='width: 100%'> 
        <td>      
       <button onclick="location.href='<?php echo e(url('isostatus')); ?>'" type="button" class="btn btn-info btn-lg" style="width:32%"><b>Status</b>
        </button>
         <button onclick="location.href='<?php echo e(url('hisoctrl')); ?>'" type="button" class="btn btn-info btn-lg" style="width:32%"><b>History</b>
        </button>
        <?php if (auth()->user()->hasRole('DesignAdmin')){ ?> 
        <button onclick="location.href='<?php echo e(url('file')); ?>'" type="button" class="btn btn-info btn-lg" style="width:32%"><b>Upload Isofiles</b>
        </button><?php }?>
        <?php if (auth()->user()->hasRole('DesignAdmin')){ ?> 
...
<?php echo $__env->make('isoctrl.commentsfromdesigntolead', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.rejectfromldgdesign', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.commentsfromldgdesigntosupports', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.commentsfromldgdesigntostress', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('isoctrl.commentsfromldgdesigntomaterials', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
