                    ...
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                <tr>
                                    ...
                                    <td>
                                        <?php echo Form::select('tequis_id', [null => 'Select Type...'] + $tequis, null, array('class' => 'tequis_id','style'=>'height:31px','required')); ?>

                                    </td>
                                    <td>
                                        <?php echo Form::number('est_qty', null, array('placeholder' => 'Quantity','class' => 'est_qty','required')); ?>
