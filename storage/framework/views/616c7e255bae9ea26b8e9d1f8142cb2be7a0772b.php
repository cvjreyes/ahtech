    ...
    $(function () {
        $('.add').click(function () {
            ...
            var tr = '<tr class="fila">' +
                    ...
                    '<td><?php echo Form::select('tcivils_id[]', [null => 'Select Type...'] + $tcivils, null, array( 'style'=>'height:34px;font-size: 14px;font-weight: normal;','required')); ?></td>'+
...
<?php if(auth()->check() && auth()->user()->hasRole('CivilAdmin')): ?><button style="align:right" type="button" class="btn btn-lg btn-default" data-toggle="modal" data-target="#createcivilModal"><img src="<?php echo e(asset('images/add-icon.ico')); ?>" style="width:23px" ></button>&nbsp;<?php endif; ?>
...
<button onclick="location.href='<?php echo e(url('exportcivil')); ?>'" type="button" class="btn btn-lg btn-success" style="font-size: 16px;font-weight: bold">Excel</button><br>
...
<table border id="ecivil" class="table table-hover table-condensed" style="width: 100%;font-size: 14px;font-weight: normal;white-space: nowrap">
    <center><thead>
        <tr>
           ...
           <!--  <th>Quantity</th> -->
            <!-- <th>Estimated</th> -->
            <?php if(auth()->check() && auth()->user()->hasRole('CivilAdmin')): ?> <th>Action</th> <?php endif; ?>
        </tr>
    </thead></center>
    <tfoot><tr>
...
<!--             <th style="text-align: center"></th> -->
            <!-- <th style="text-align: center"></th> -->
            <?php if(auth()->check() && auth()->user()->hasRole('CivilAdmin')): ?> <th style="text-align: center"></th> <?php endif; ?>
        </tr></tfoot>
  </table>
...
<?php if(auth()->check() && auth()->user()->hasRole('CivilAdmin')): ?>
    <script type="text/javascript">
...
?>
  ...
  <center>
  <button onclick="location.href='<?php echo e(url('modeledcivil')); ?>'" type="button" class="btn btn-primary btn-lg">Modeled</button>
