                    ...
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo Form::text('name[]', null, array('placeholder' => 'Calculation Note','class' => 'form-control','style' => 'text-transform: uppercase','required')); ?>
                        ...
                        <input onclick="location.href='<?php echo e(url('pipes')); ?>'" type="submit" class="btn btn-lg btn-default" data-dismiss="modal" value="Cancel">
