    ...
    $(function () {
        $('.add').click(function () {
            ...
            var tr = '<tr class="fila">' +
                    '<td><?php echo Form::select('areas_id[]', [null => 'Select Area...'] + $areas, null, array( 'style'=>'height:34px;font-size: 14px;font-weight: normal;','rcivilred')); ?></td>'+
                    '<td><?php echo Form::select('tcivils_id[]', [null => 'Select Type...'] + $type_civil, null, array( 'style'=>'height:34px;font-size: 14px;font-weight: normal;','rcivilred')); ?></td>'+
                    '<td><?php echo Form::number('qty[]', null, array('placeholder' => 'Qty','class' => 'form-control','style' => 'width: 75px;font-size: 14px;font-weight: normal;','rcivilred')); ?></td>'+
...
<?php if(auth()->check() && auth()->user()->hasRole('CivilAdmin')): ?>
    ...
    $(document).ready(function() {
        oTable = $('#ecivil').DataTable({
            ...
            "processing": true,
            "serverSide": false,
            "ajax": "<?php echo e(route('civil.ecivilsfullquery')); ?>",
            "columns": [
                     {data: 'area', name: 'area'},
...
?>
  ...
  <center>
  <button onclick="location.href='<?php echo e(url('modeledcivil')); ?>'" type="button" class="btn btn-primary btn-lg">Modelled</button>
