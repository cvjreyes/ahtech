        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                   ...
                   <form style="background-color: #F5F8FA" method="POST" action="<?php echo e(route('subircommon')); ?>" accept-charset="UTF-8" enctype="multipart/form-data">
                    ...
                    <?php echo Form::text('claimed', null, array('class' => 'claimed','style' => 'display:none','readonly')); ?>


                    <?php echo Form::text('verifydesign', null, array('class' => 'verifydesign','style' => 'display:none','readonly')); ?>

                    
                    <?php echo Form::text('verifystress', null, array('class' => 'verifystress','style' => 'display:none','readonly')); ?>


                    <?php echo Form::text('verifysupports', null, array('class' => 'verifysupports','style' => 'display:none','readonly')); ?>


                      <br><center><label for="archivo" style="padding-right: 50%"><?php echo Form::text('filename', null, array('placeholder' => 'filename','class' => 'filename','style' => 'text-align:center;border:2px;width: 280%;font-size: 16px;font-weight: bold;background: #F5F8FA;border:0px','readonly')); ?></label></center><br>
