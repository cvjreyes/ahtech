...
<?php if(auth()->check() && auth()->user()->hasRole('ElecAdmin')): ?><button style="align:right" type="button" class="btn btn-lg btn-default" data-toggle="modal" data-target="#createtypeselecModal"><img src="<?php echo e(asset('images/add-icon.ico')); ?>" style="width:23px" ></button>&nbsp;<?php endif; ?>
<button onclick="location.href='<?php echo e(url('exporttypeelec')); ?>'" type="button" class="btn btn-lg btn-success" style="font-size: 16px;font-weight: bold">Excel</button><br>
...
$(document).ready(function() {
    oTable = $('#typeelec').DataTable({
        ...
        "processing": true,
        "serverSide": false,
        "ajax": "<?php echo e(route('electrical.types')); ?>",
        "columns": [
            {data: 'code', name: 'code'},
            {data: 'name', name: 'name'},
...
<script type="text/javascript">
  ...
  <button onclick="location.href='<?php echo e(url('glineelec')); ?>'" type="button" class="btn btn-primary btn-lg">Curve</button>
...
<?php echo $__env->make('electrical.deltypeselec', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('electrical.edittypeselec', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('electrical.createtypeselec', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
