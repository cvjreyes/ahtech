            ...
            <div class="container" style="">
                ...
                <div class="navbar-header" style="margin-top: 0px">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}">
                            ...
                            <img src="{{ asset('images/company-logo.png') }}" style="width:120px;padding-bottom: 0px;" >
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @role('Cliente')
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <a href="{{ route('viewcliente') }}">Ver Ficha</a>
                                </li>        
                            </ul>
                        </li>
                        @endrole
                        ...
                        @role('Admin')
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li style="font-size: 13px">
                                <a href="{{ route('tablaclientes') }}">Clientes</a>
                                </li>        
                            </ul>
                        </li>
                        @endrole
                               ...
                               <li id="s00"><a href=""><img src="{{ asset('images/client-logo.png') }}" style="width:100px;"></a></li>
