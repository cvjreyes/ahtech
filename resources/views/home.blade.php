      ...
      function controltag(e) {
       ...
       <div class="col-md-4 col-md-offset-4" style="margin-top: 5%">
        ...
        <div style='margin-left: 15%;'>
          ...
          <br>IBAN(*): ES {!! Form::text('iban', $datauser->iban, array( 'style' =>'width:175px','class' => 'iban','maxlength' =>22,'minlength' =>22,'onkeypress' => 'return controltag(event)','required')) !!}

          &nbsp;&nbsp;DNI: {!! Form::text('dni', $datauser->dni, array('style' =>'width:70px','class' => 'dni','maxlength' =>8,'minlength' =>8,'onkeypress' => 'return controltag(event)')) !!}
        
          <br><br>Dirección de Facturación:
          <br>{{ Form::textarea('direccion', $datauser->direccion, ['class' => 'direccion' , 'cols' => 50, 'rows' =>10, 'maxlength' => "400"]) }}
                    ...
                    <br><br>
                        ...
                        <button onclick="location.href='{{ url('viewcliente') }}'" type="button" class="btn btn-default btn-lg" style="width:15%">Ver</button>&nbsp;&nbsp;
